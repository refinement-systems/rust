...
// The writable scratch directory (rev2§5.1). Resolved from the `TMPDIR` environment
...
// (names are handle-relative, rev2§4.9), so this is a name a program hands to its
